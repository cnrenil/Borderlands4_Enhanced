...
namespace
{
    ...
    void ApplyBaseLayout(ImGuiStyle& style)
    {
        ...
        style.WindowMinSize = ImVec2(480.0f, 360.0f);
    ...
    void ApplyOceanGlass(ImGuiStyle& style)
    {
        ...
        colors[ImGuiCol_Border] = ImVec4(0.22f, 0.27f, 0.33f, 0.85f);
        colors[ImGuiCol_BorderShadow] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
        colors[ImGuiCol_FrameBg] = ImVec4(0.13f, 0.16f, 0.21f, 1.00f);
        colors[ImGuiCol_FrameBgHovered] = ImVec4(0.18f, 0.24f, 0.31f, 1.00f);
        colors[ImGuiCol_FrameBgActive] = ImVec4(0.22f, 0.31f, 0.40f, 1.00f);
        colors[ImGuiCol_TitleBg] = ImVec4(0.06f, 0.08f, 0.11f, 0.98f);
        colors[ImGuiCol_TitleBgActive] = ImVec4(0.10f, 0.14f, 0.18f, 0.98f);
        colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.06f, 0.08f, 0.11f, 0.82f);
        colors[ImGuiCol_MenuBarBg] = ImVec4(0.09f, 0.11f, 0.15f, 0.95f);
        colors[ImGuiCol_ScrollbarBg] = ImVec4(0.07f, 0.08f, 0.11f, 0.72f);
        colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.26f, 0.32f, 0.39f, 0.95f);
        colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.36f, 0.45f, 0.55f, 0.95f);
        colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.47f, 0.58f, 0.71f, 0.95f);
        ...
        colors[ImGuiCol_Button] = ImVec4(0.16f, 0.42f, 0.49f, 0.88f);
        colors[ImGuiCol_ButtonHovered] = ImVec4(0.22f, 0.56f, 0.64f, 0.95f);
        colors[ImGuiCol_ButtonActive] = ImVec4(0.12f, 0.33f, 0.39f, 1.00f);
        colors[ImGuiCol_Header] = ImVec4(0.14f, 0.33f, 0.40f, 0.85f);
        colors[ImGuiCol_HeaderHovered] = ImVec4(0.20f, 0.47f, 0.57f, 0.90f);
        colors[ImGuiCol_HeaderActive] = ImVec4(0.23f, 0.55f, 0.67f, 0.92f);
        ...
        colors[ImGuiCol_ResizeGrip] = ImVec4(0.30f, 0.45f, 0.54f, 0.35f);
        colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.44f, 0.65f, 0.78f, 0.80f);
        colors[ImGuiCol_ResizeGripActive] = ImVec4(0.58f, 0.83f, 0.97f, 0.95f);
        ...
        colors[ImGuiCol_TableHeaderBg] = ImVec4(0.11f, 0.14f, 0.18f, 1.00f);
        colors[ImGuiCol_TableBorderStrong] = ImVec4(0.24f, 0.28f, 0.33f, 1.00f);
        colors[ImGuiCol_TableBorderLight] = ImVec4(0.16f, 0.19f, 0.24f, 1.00f);
        colors[ImGuiCol_TableRowBg] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
        colors[ImGuiCol_TableRowBgAlt] = ImVec4(0.11f, 0.13f, 0.17f, 0.35f);
        ...
        colors[ImGuiCol_ModalWindowDimBg] = ImVec4(0.02f, 0.03f, 0.05f, 0.72f);
    }
    ...
    void ApplyEmberNight(ImGuiStyle& style)
    {
        ...
        colors[ImGuiCol_ChildBg] = ImVec4(0.14f, 0.10f, 0.10f, 0.78f);
    ...
    void ApplyMonoSlate(ImGuiStyle& style)
    {
        ...
        colors[ImGuiCol_ChildBg] = ImVec4(0.13f, 0.14f, 0.16f, 0.82f);
