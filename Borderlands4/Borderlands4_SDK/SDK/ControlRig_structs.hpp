...
public:
	...
	class UControlRig*                            ControlRig;                                        // 0x0270(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	TMap<TSubclassOf<class UObject>, class UControlRig*> ControlRigPerClass;                         // 0x0278(0x0050)(Transient, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
