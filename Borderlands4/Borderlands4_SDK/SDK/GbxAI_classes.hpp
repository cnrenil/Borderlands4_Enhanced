...
public:
	...
	class UCoverSlotData*                         SlotType;                                          // 0x03B8(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	...
	TArray<class UCoverSlotComponent*>            Slots;                                             // 0x03D0(0x0010)(Edit, ExportObject, ZeroConstructor, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
...
{
public:
	class UCoverSlotData*                         SlotType;                                          // 0x0620(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	...
	TArray<class UCoverSlotComponent*>            OverlappingSlots;                                  // 0x0650(0x0010)(Edit, ExportObject, ZeroConstructor, EditConst, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
	class AActor*                                 CurrentUser;                                       // 0x0660(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
...
public:
	...
	TArray<class UCoverViewData*>                 Views;                                             // 0x0098(0x0010)(Edit, ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic, TObjectPtr)
...
public:
	...
	class UCoverViewData*                         View;                                              // 0x0040(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoClear, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
...
public:
	...
	class AActor*                                 ChildActor;                                        // 0x02C8(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, TextExportTransient, NonPIEDuplicateTransient, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
	class AActor*                                 ReplicatedChildActor;                              // 0x02D0(0x0008)(Net, ZeroConstructor, Transient, RepNotify, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
	...
	class UGbxChildActorComponentReplicator*      Replicator;                                        // 0x02E8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected, TObjectPtr)
...
public:
	...
	class UAnimSequence*                          IdleHigh;                                          // 0x00C0(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	class UAnimSequence*                          IdleLow;                                           // 0x00C8(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	class UAnimSequence*                          ExitHigh;                                          // 0x00D0(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	class UAnimSequence*                          ExitLow;                                           // 0x00D8(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
...
// 0x07A0 (0x0FF0 - 0x0850)
class AGbxAICharacter : public AGbxNavCharacter
{
public:
	uint8                                         Pad_850[0x18];                                     // 0x0850(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void(class AActor* NewTarget)> TargetChangedEvent;                      // 0x0868(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_878[0x68];                                     // 0x0878(0x0068)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGbxTargetableState                    TargetableState;                                   // 0x08E0(0x01C8)(NativeAccessSpecifierPublic)
	struct FGbxTargeterState                      TargetingState;                                    // 0x0AA8(0x0318)(NativeAccessSpecifierPublic)
	struct FGbxPerceiverState                     PerceiverState;                                    // 0x0DC0(0x0128)(NativeAccessSpecifierPublic)
	struct FGbxAggroState                         AggroState;                                        // 0x0EE8(0x0108)(NativeAccessSpecifierPublic)
...
{
public:
	class UGbxChildActorComponent*                TargetComponent;                                   // 0x02A8(0x0008)(ExportObject, ZeroConstructor, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
	...
	class AActor*                                 ReplicatedChildActor;                              // 0x02B8(0x0008)(Net, ZeroConstructor, Transient, RepNotify, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
...
public:
	...
	class ASpawner*                               Spawner;                                           // 0x0408(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
	...
	class UGbxBrainTaskData*                      PerceiverTask;                                     // 0x04F0(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, TObjectPtr)
...
public:
	...
	class UGbxTerritoryComponent*                 TerritoryComponent;                                // 0x0398(0x0008)(Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
...
public:
	...
	TArray<class UGbxTerritoryComponent*>         LinkedTerritories;                                 // 0x09A8(0x0010)(ExportObject, ZeroConstructor, Transient, ContainsInstancedReference, UObjectWrapper, NativeAccessSpecifierPrivate, TObjectPtr)
...
public:
	...
	class UGbxBrainTaskData*                      BrainGraph;                                        // 0x0640(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
...
public:
	...
	class AGbxTerritory*                          Territory;                                         // 0x0040(0x0008)(Edit, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate, TObjectPtr)
