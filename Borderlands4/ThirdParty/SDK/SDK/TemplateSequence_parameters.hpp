...
public:
	...
	struct FMinimalViewInfo                       ReturnValue;                                       // 0x0010(0x0A30)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FPostProcessSettings                   OutPPSettings;                                     // 0x0010(0x08C0)(Parm, OutParm, NativeAccessSpecifierPublic)
	float                                         OutPPBlendWeight;                                  // 0x08D0(0x0004)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x08D4(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_8D5[0xB];                                      // 0x08D5(0x000B)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
