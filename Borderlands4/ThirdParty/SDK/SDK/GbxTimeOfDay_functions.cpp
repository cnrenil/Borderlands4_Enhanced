...
// Function GbxTimeOfDay.TimeOfDayVolume.OnBrushComponentPhysicsStateChanged
// (Final, Native, Public)
// Parameters:
...
void ATimeOfDayVolume::OnBrushComponentPhysicsStateChanged(class UPrimitiveComponent* ChangedComponent, EComponentPhysicsStateChange StateChange)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("TimeOfDayVolume", "OnBrushComponentPhysicsStateChanged");

	Params::TimeOfDayVolume_OnBrushComponentPhysicsStateChanged Parms{};
...
// Function GbxTimeOfDay.TimeOfDayWeatherOverrideVolume.OnBrushComponentPhysicsStateChanged
// (Final, Native, Public)
// Parameters:
// class UPrimitiveComponent*              ChangedComponent                                       (Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// EComponentPhysicsStateChange            StateChange                                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void ATimeOfDayWeatherOverrideVolume::OnBrushComponentPhysicsStateChanged(class UPrimitiveComponent* ChangedComponent, EComponentPhysicsStateChange StateChange)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("TimeOfDayWeatherOverrideVolume", "OnBrushComponentPhysicsStateChanged");

	Params::TimeOfDayWeatherOverrideVolume_OnBrushComponentPhysicsStateChanged Parms{};
